                        ...
                        <div class="input-group mb-4">
                            ...
                            <div class="col-md-auto">
                                <div class="row px-2">
                                    ...
                                    <div class="col-md-auto">
                                        <input type="text" name="business_classification" id="business_classification_other_detail" placeholder="Other" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row px-2 py-2" style="line-height: 1">
                        ...
                        <div class="input-group d-flex justify-content-end mr-4 mb-4 mt-4">
                            <button type="button" class="btn btn-primary" id="add_bank"> + Bank</button>
                        </div>
                ...
                <div class="card-body">
                    <div class="row px-2 py-2" style="line-height: 1">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="tax_invoice_serial_number" id="tax_invoice_serial_number" placeholder="" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="company_address_additional" id="company_address_additional">  
                            <div class="input-group mb-4">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <input type="text" name="address_add_info" id="address_add_info" placeholder="" class="form-control">
                                        </div>
                                        <div class="col-md-auto">
                                            <div class="row">
                                                <div class="col-md-auto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col align-items-end mr-4">
                                            <button type="button" class="btn btn-primary float-right" id="add_info">+ Address</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row px-2 py-2" style="line-height: 1">
                        <div class="input-group mt-2">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" href="#document_type_pt" role="tab" data-toggle="tab">PT</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#document_type_cv" role="tab" data-toggle="tab">CV</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#document_type_ud_or_pd" role="tab" data-toggle="tab">UD/PD</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#document_type_perorangan" role="tab" data-toggle="tab">Perorangan</a>
                                </li>
                            </ul>
                            <div class="tab-content mt-4">
                                <div role="tabpanel" class="tab-pane fade in" id="document_type_pt">
                        ...
                        <div class="dynamic_list_document" style="width: 100%"></div>
                        <div class="input-group mt-4">
                            <div class="row">
                                <div class="col-md-auto">
                                    <div class="mb-3">
                                        <label for="remark" class="form-label">Remarks FromSupplier (If any)</label>
                                        <p class="fs-6" style="margin-bottom: 0.5rem !important; font-size: 10px !important;">
                                            Keterangan dari Supplier (jika ada)</p>
                                        <input type="text" class="form-control" id="remark" name="remark">
                                    </div>
                                </div>
                                <div class="col-md-auto">
                                    <div class="mb-3">
                                        <label for="signature" class="form-label">Signature Scan File</label>
                                        <p class="fs-6" style="margin-bottom: 0.5rem !important; font-size: 10px !important;">
                                            Tanda Tangan</p>
                                ...
                                <div class="col-md-auto">
                                    <div class="mb-3">
                                        <label for="stamp" class="form-label">Stamp Scan File</label>
                                        <p class="fs-6" style="margin-bottom: 0.5rem !important; font-size: 10px !important;">
                                            Stempel</p>
