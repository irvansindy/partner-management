<div class="modal fade" id="ModalDetailPartner" data-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="ModalDetailPartnerLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalDetailPartnerLabel">Detail Partner</h5>
                            ...
                            <div class="card-body">
                                <div class="row px-2 py-2" style="line-height: 1">
                                    ...
                                    <div class="input-group my-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="hidden" name="detail_company_id" id="detail_company_id"
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_established_year"
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_total_employee"
                                                        id="detail_total_employee" placeholder="" class="form-control">
                                                </div>
                                    ...
                                    <div class="detail_company_address_additional"
                                        id="detail_company_address_additional">
                                        {{-- <fieldset>
                                        </fieldset> --}}
                                        <div class="input-group mb-4">
                                            <div class="col-md-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-4">
                                                        <input type="text" name="detail_address[]"
                                                            id="detail_address" placeholder="" class="form-control">
                                                    </div>
                                                    <div class="col-md-auto">
                                                        <div class="row">
                                                            <div class="col-md-auto">
                                                            ...
                                                            <div class="col-md-auto">
                                                                <input type="text" name="detail_city[]"
                                                                    id="detail_city" placeholder=""
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-auto mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-auto">
                                                                <input type="text" name="detail_country[]"
                                                                    id="detail_country" placeholder=""
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-auto mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-auto">
                                                                <input type="text" name="detail_province[]"
                                                                    id="detail_province" placeholder=""
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-auto mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-auto">
                                                                <input type="text" name="detail_zip_code[]"
                                                                    id="detail_zip_code" placeholder=""
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-auto mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-auto">
                                                                <input type="text" name="detail_telephone[]"
                                                                    id="detail_telephone" placeholder=""
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-auto mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-auto">
                                                                <input type="text" name="detail_fax[]"
                                                                    id="detail_fax" placeholder=""
                                                                    class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="input-group mt-4">
                                        <div class="col-md-6 mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_bank_name[]"
                                                        id="detail_bank_name" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_branch[]" id="detail_branch"
                                                        placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="input-group">
                                        <div class="col-md-6 mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_account_name[]"
                                                        id="detail_account_name" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_city_or_country[]"
                                                        id="detail_city_or_country" placeholder=""
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="input-group">
                                        <div class="col-md-auto mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_account_number[]"
                                                        id="detail_account_number" placeholder=""
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-auto mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_currency[]"
                                                        id="detail_currency" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-auto">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_swift_code[]"
                                                        id="detail_swift_code" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row px-2 py-2" id="list_detail_tax" style="line-height: 1">
                                    <div class="input-group mt-4">
                                        <div class="col-md-auto mb-4">
                                            <div class="row">
                                                <div class="col-md-auto">
                                                    <label for="detail_register_number_as_in_tax_invoice">Tax Register
                                                        Number
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text"
                                                        name="detail_register_number_as_in_tax_invoice"
                                                        id="detail_register_number_as_in_tax_invoice" placeholder=""
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-auto mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_trc_number"
                                                        id="detail_trc_number" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input-group">
                                        <div class="col-md-auto mb-4">
                                            <div class="row">
                                                <div class="col-md-auto">
                                                    <label for="detail_register_number_related_branch">Tax Register
                                                        Number
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="text" name="detail_register_number_related_branch"
                                                        id="detail_register_number_related_branch" placeholder=""
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-auto mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-auto">
                                                    <input type="date" name="detail_valid_until"
                                                        id="detail_valid_until" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input-group mb-4">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="detail_taxable_entrepreneur_number"
                                                id="detail_taxable_entrepreneur_number" placeholder=""
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="input-group mb-4">
                                        <div class="col-md-3">
                                            <label for="detail_tax_invoice_serial_number">Tax Invoice Serial No.
                                                *</label>
                                            <p class="fs-6"
                                                style="margin-bottom: 0.5rem !important; font-size: 10px !important;">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="detail_tax_invoice_serial_number"
                                                id="detail_tax_invoice_serial_number" placeholder=""
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row px-2 py-2" style="line-height: 1">
                                    <div class="container-fluid">
                                        <ul class="nav nav-tabs mb-4" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#detail_document_type_pt"
                                                    role="tab" data-toggle="tab">PT</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#detail_document_type_cv" role="tab"
                                                    data-toggle="tab">CV</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#detail_document_type_ud_or_pd"
                                                    role="tab" data-toggle="tab">UD/PD</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#detail_document_type_perorangan"
                                                    role="tab" data-toggle="tab">Perorangan</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content mt-5">
                                            <div role="tabpanel" class="tab-pane fade table-responsive-lg active show"
                                                id="detail_document_type_pt">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade table-responsive-lg"
                                                id="detail_document_type_cv">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade table-responsive-lg"
                                                id="detail_document_type_ud_or_pd">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Doc Type</th>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade table-responsive-lg"
                                                id="detail_document_type_perorangan">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Doc Type</th>
