    ...
    <div class="card-body">
        <div class="company_address_additional" id="company_address_additional">
            <fieldset class="border rounded-3 p-3 mb-4">
                <legend class="float-none w-auto px-2 fw-semibold">@lang('messages.Address Data')</legend>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="country[]" id="country_0" class="form-control" value="Indonesia" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="province[]" id="select_option_province_0" class="form-control select2"></select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="city[]" id="select_option_regency_0" class="form-control select2"></select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="zip_code[]" id="zip_code_0" class="form-control" data-maxlength="5" maxlength="5" placeholder="@lang('messages.Placeholder Address Postal Code')">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="telephone[]" id="telephone_0" class="form-control" data-maxlength="13" maxlength="13" placeholder="@lang('messages.Placeholder Address Telephone')">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="fax[]" id="fax_0" class="form-control" data-maxlength="15" maxlength="15" placeholder="@lang('messages.Placeholder Address Fax')">
            ...
            <fieldset class="border rounded-3 p-3 mb-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            <input type="text" id="search_address_1" class="form-control" placeholder="Masukkan alamat untuk dicari...">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        <div id="map_1" class="rounded-3" style="width: 100%; height: 400px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"></div>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12">
                        ...
                        <select id="select_searched_address_1" class="form-control select2" disabled>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="form-text">@lang('messages.Format Address')</div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="longitude" id="longitude_1" class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="country[]" id="country_1" class="form-control" value="Indonesia" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="province[]" id="select_option_province_1" class="form-control select2"></select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="city[]" id="select_option_regency_1" class="form-control select2"></select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="zip_code[]" id="zip_code_1" class="form-control" data-maxlength="5" maxlength="5" placeholder="@lang('messages.Placeholder Address Postal Code')">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <p class="fs-6 text-muted mb-2">@lang('messages.Telephone Info')</p>
                            <input type="number" name="telephone[]" id="telephone_1" class="form-control" data-maxlength="13" maxlength="13" placeholder="@lang('messages.Placeholder Address Telephone')">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <p class="fs-6 text-muted mb-2">@lang('messages.Fax Info')</p>
                            <input type="number" name="fax[]" id="fax_1" class="form-control" data-maxlength="15" maxlength="15" placeholder="@lang('messages.Placeholder Address Fax')">
...
<script>
    function initializeLeafletAddress1() {
        if (typeof L === 'undefined' || !L.Icon || !L.Icon.Default) {
            setTimeout(initializeLeafletAddress1, 100);
            return;
        }
...
window.addEventListener('load', initializeLeafletAddress1);
</script>
