...
@section('content')
    @push('styles')
        ...
        <style>
            ...
            #department_table tbody tr:last-child td {
                border-bottom: 0;
            }

            #department_table tbody tr:hover td {
                background: var(--setting-row-hover);
            }

            #department_table .btn {
                border-radius: 6px;
                margin: 0 4px 0 0;
                min-width: 62px;
            }
    ...
    <div class="setting-page">
        <div class="setting-page-header">
            <div>
                ...
                <p>Manage department master data used in the organization structure.</p>
            </div>
            <button type="button" class="btn btn-primary waves-effect" id="for_create_department" data-toggle="modal" data-target="#formDepartment" data-backdrop="static" data-keyboard="false">
        ...
        <div class="card setting-table-card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover mb-0" id="department_table" width="100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
