                ...
                <div class="card mb-4">
                    <div class="card-header d-flex bd-highlight">
                        ...
                        <div class="p-2 flex-fill bd-highlight d-flex justify-content-end" style="float: right !important;">
                            <button type="button" class="btn bg-gradient-primary" id="for_create_office" data-toggle="modal" data-target="#formOffice" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="card-body px-0 pt-2 pb-2">
                        <div class="table-responsive p-0 px-md-2">
                            <table class="table table-hover align-items-center mb-0 data_tables" id="office_table" width="100%">
                                <thead>
                                    <tr>
