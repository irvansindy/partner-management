<!-- Modal -->
<div class="modal fade" id="formCreateUser" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    aria-labelledby="formCreateUser_label" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="" id="form_create_new_user">
                <div class="modal-body">
                    <div class="row">
                        <!-- Name -->
                        <div class="form-group mb-3 col-md-6 col-lg-6 col-sm-12">
                        ...
                        <div class="form-group mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <select class="form-control" name="user_job_title" id="user_job_title"
                                style="width: 100% !important;">
                        ...
                        <div class="form-group mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <select class="form-control" name="user_division" id="user_division"
                                style="width: 100% !important;">
                        ...
                        <div class="form-group mb-3 col-md-6 col-lg-6 col-sm-12">
                            ...
                            <select class="form-control" name="user_parent" id="user_parent"
                                style="width: 100% !important;">
